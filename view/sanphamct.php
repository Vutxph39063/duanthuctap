        ...
        <div class="row px-xl-5">
            <div class="col-lg-5 mb-30">
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        ...
                        extract($onesp);
                    $anh = $img_path.$anh;
                    echo "<img src='$anh' class=".'w-100 h-100"'." width='200'><br>";
                    // echo'<div class="row mb spct"><img src"'.$anh.'"><br>';
                        ...
                        <!-- <div class="carousel-item">
                            <img class="w-100 h-100" src="upload/" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="upload/" alt="Image">
                        </div>
            ...
            <div class="col-lg-7 h-auto mb-30">
                ...
                <!--  -->
                    ...
                    <h3 class="font-weight-semi-bold mb-4"><?=$gia_ban.'đ';?></h3>
            ...
            <div class="col">
                <div class="bg-light p-30">
                    <div class="nav nav-tabs mb-4">
                        <a class="nav-item nav-link text-dark active" data-toggle="tab" href="#tab-pane-1">Mô tả sản phẩm
                        
                        </a>
                        <!-- <a class="nav-item nav-link text-dark" data-toggle="tab" href="#tab-pane-2">Thông tin</a>
                        <a class="nav-item nav-link text-dark" data-toggle="tab" href="#tab-pane-3">Đánh gi(0)</a> -->
                    </div>
